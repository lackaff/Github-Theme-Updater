...
class WPGitHubUpdater {
	...
	public function __construct( $config = array() ) {
		...
		$defaults = array(
			...
			'api_url' => 'https://api.github.com/repos/afragen/'.$this->config->repo,
			'raw_url' => 'https://raw.github.com/afragen/'.$this->config->repo.'/master',
			'github_url' => 'https://github.com/afragen/'.$this->config->repo,
			'zip_url' => 'https://github.com/afragen/'.$this->config->repo.'/zipball/master',
			'sslverify' => true,
			'requires' => $wp_version,
			'tested' => $wp_version,
			'readme' => 'readme.txt'
